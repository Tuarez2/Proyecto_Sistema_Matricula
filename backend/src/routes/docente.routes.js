...
router.get('/', rolesLectura, validarListadoDocentes, validarSolicitud, obtenerDocentes);
router.get('/:id', rolesLectura, validarIdParam, validarSolicitud, obtenerDocentePorId);
